...
export function registerCylinder() {
    registerShape('cylinder', (params = {}, context = {}) => {
        ...
        const usesCustomFill = raw.cylinderUsesCustomFill === false || raw.cylinderUsesCustomFill === 'false'
            ? false
            : true;
        options.push(usesCustomFill ? 'cylinder uses custom fill' : 'cylinder uses custom fill=false');
