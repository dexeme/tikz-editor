...
const DEFAULT_CYLINDER_MIN_WIDTH_CM = 1.6;
const DEFAULT_CYLINDER_MIN_HEIGHT_CM = 1.8;
const DEFAULT_CYLINDER_CONTENT_HEIGHT = 24;
const DEFAULT_CYLINDER_ASPECT = 0.35;
